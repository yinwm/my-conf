...
(defvar java-constant-regexp nil
  "My definition for a Java constant (all caps).")
	...
	(list
	 ...
	 (list
	  (concat
	   ...
	   "using\\|base\\|namespace\\|new\\|package\\|return\\|switch\\|"
	   "t\\(hrows?\\|ry\\)\\|while\\)\\>")
	 ...
	 (list java-constant-regexp '(1 font-lock-constant-face))))
